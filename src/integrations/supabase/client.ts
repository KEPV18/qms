...
const SUPABASE_ANON_KEY = SUPABASE_KEY_RAW ? String(SUPABASE_KEY_RAW).trim() : undefined

export const supabase = SUPABASE_URL && SUPABASE_ANON_KEY && SUPABASE_URL.length > 0 && SUPABASE_ANON_KEY.length > 0
